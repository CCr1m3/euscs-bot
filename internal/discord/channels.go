...
func initChannels() error {
	...
	if AiMiChannels == nil {
		...
		if err != nil {
			log.Fatalf("failed to create channel group Ai.Mi: ", err.Error())
		}
	}
	if HowToChannel == nil {
		...
		if err != nil {
			log.Fatalf("failed to create channel how-to: ", err.Error())
		}
		...
		if err != nil {
			log.Fatalf("failed to lock channel matches: ", err.Error())
		}
	}
	if MatchesChannel == nil {
		...
		if err != nil {
			log.Fatalf("failed to create channel matches: ", err.Error())
		}
		...
		if err != nil {
			log.Fatalf("failed to open channel matches for bot: ", err.Error())
		}
	}
	err = initHowTo()
	if err != nil {
		log.Fatalf("failed to init howto channel: ", err.Error())
	}
	return nil
}
